...
posttype: project
post-image: https://cdn.bouldermon.com/project00002/initial.jpg
...
<p align="center">
  <img src="https://cdn.bouldermon.com/project00002/create_bucket_name.png">
</p>
...
<p align="center">
  <img src="https://cdn.bouldermon.com/project00002/block_all_public_access.png">
</p>

생성을 완료하면 아래와 같이 S3 console에 생성된 Bucket이 표시된다.

<p align="center">
  <img src="https://cdn.bouldermon.com/project00002/created_bucket.png">
</p>
...
<p align="center">
  <img src="https://cdn.bouldermon.com/project00002/bucket_add_folder.png">
</p>
...
<p align="center">
  <img src="https://cdn.bouldermon.com/project00002/bucket_storage_class.png">
</p>
...
<p align="center">
  <img src="https://cdn.bouldermon.com/project00002/fail_access_obj_url.png">
</p>
...
<p align="center">
  <img src="https://cdn.bouldermon.com/project00002/cf_origin_setting.png">
</p>
...
<p align="center">
  <img src="https://cdn.bouldermon.com/project00002/cf_origin_access_setting.png">
</p>

CloudFront는 항상 들어오는 요청에 서명하기 때문에 AWS 권장에 따라 **Sign requests**를 체크한 후 **Create control setting**을 생성했다.

<p align="center">
  <img src="https://cdn.bouldermon.com/project00002/oac_create_control_setting.png">
</p>

https만 허용하는 **Viewer protocol policy** 설정을 제외하곤 나머지 설정은 모두 기본 설정으로 체크했다. **Web Application Firewall (WAF)**도 미사용으로 진행했다.

<p align="center">
  <img src="https://cdn.bouldermon.com/project00002/cf_viewer_setting.png">
</p>
...
<p align="center">
  <img src="https://cdn.bouldermon.com/project00002/cf_bucket_policy_update.png">
</p>

링크를 타고 S3 Bucket으로 넘어가서 **Bucket Policy**를 수정한다.

<p align="center">
  <img src="https://cdn.bouldermon.com/project00002/s3_bucket_policy_change.png">
</p>
...
<p align="center">
  <img src="https://cdn.bouldermon.com/project00002/cf_s3_image.png">
...
<p align="center">
  <img src="https://cdn.bouldermon.com/project00002/create_record_cf.png">
</p>

Record 생성 후 CloudFront console로 이동하여 **Alternate domain name (CNAME) - optional**에 Route53에서 생성한 Record명을 입력한다.
<p align="center">
  <img src="https://cdn.bouldermon.com/project00002/cf_alternate_domain_name.png">
</p>
...
<p align="center">
  <img src="https://cdn.bouldermon.com/project00002/cf_custom_certificate_none.png">
</p>
...
<p align="center">
  <img src="https://cdn.bouldermon.com/project00002/cf_virginia_certificate_create.png">
</p>
...
<p align="center">
  <img src="https://cdn.bouldermon.com/project00002/cf_custom_certificate_selected.png">
</p>

이제 Route53에서 등록했던 CDN Record를 통해 S3 Bucket에 접근할 수 있게 되었다.
<p align="center">
  <img src="https://cdn.bouldermon.com/project00002/cf_cdn_s3_image.png">
</p>
...
<p align="center">
  <img src="https://cdn.bouldermon.com/project00002/cache_hit_and_cors_error.png">
</p>
...
<p align="center">
  <img src="https://cdn.bouldermon.com/project00002/img_font_origin_tags.png">
...
<p align="center">
  <img src="https://cdn.bouldermon.com/project00002/cf_behavior_origin_request_policy_setting.png">
...
<p align="center">
  <img src="https://cdn.bouldermon.com/project00002/cf_behavior_response_policy_setting.png">
...
<p align="center">
  <img src="https://cdn.bouldermon.com/project00002/overview.png">
